...
if __name__ == "__main__":
    ...
    generator = PlotGenerator(
        vector_store_path = "/Users/loyalshababo/dev/plotreader/sandbox/storage",
    ...
    generator.run(
        ...
        # ) 
        data_scenario = "Choose a complicated or interesting plot other than a line graph or bar plot, but it doesn't have to hypercomplex. Make it look like a modern paper that explore high dimensional and complex data. Also, make it publication level pretty."
    )